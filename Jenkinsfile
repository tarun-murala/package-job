            ...
            post {
                always {
                    ...
                    curl --header "Content-Type: application/json" \
                        ...
                        -L "https://$SN_CREDS_USR:$SN_CREDS_PSW@devopsdemo.service-now.com/api/sn_devops/v1/devops/tool/test?toolId=063f7836dbe998109872186c139619e2&testType=Selenium"
                    """
                }
          }
        }
